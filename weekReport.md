...
---
一、本周主要工作内容：
1. 跟进用户运营1.3测试并修复bug(测试通过)；
2. 广告2.0开发(测试中)：
3. 广告2.1开发(80%)：
    * 2650 【5.6.6相关】广告新增搜索的置顶广告(80%);
    * 2651 【5.6.6相关】多种活类型的搜索广告展示 (100%);
    * 2664 【5.6.6相关】广告新增高亮热词(70%);
4. 开发进度添加甘特图功能(80%);
...
---
一、本周主要工作内容：
1. 跟进用户运营1.3测试并修复bug(测试中)；
2. 广告2.0开发(提交测试)：
    * 2584 广告增加overlay埋点(100%)
    * 2582 针对广告主的话题，通过小号系统进行自动回复(100%)
        * 初步完成多个图片展示；
        * 初步完成excel回复内容解析
    * 2576 同一时段下，相同位置可以创建多个不同定向的广告
    * 2574 在后台增加是否回传设备号的勾选框(100%)
    * 2573 试用活动增加申请理由输入框(100%)
    * 活动主题-试用活动标题详情页改成微信分享页面(100%)；
3. 开发进度添加甘特图功能(10%);
...
3. 广告2.0开发(40%)：
    * 2584 广告增加overlay埋点(100%)
    * 2582 针对广告主的话题，通过小号系统进行自动回复(50%)
        * 初步完成多个图片展示；
        * 初步完成excel回复内容解析
    * 2576 同一时段下，相同位置可以创建多个不同定向的广告
    * 2574 在后台增加是否回传设备号的勾选框(90%)
    * 2573 试用活动增加申请理由输入框(0%)
